...
from std_msgs.msg import Int32, Int32MultiArray  # "std_msgs.msg" is from ROS, and Int32 is a ROS message type. 
...
def talker(): 
    ...
    rosTimer = rospy.Rate(60);  # Frequency in Hz
    ...
    while not rospy.is_shutdown():
        ...
        msg_enc.data = [leftEnc, rightEnc]  # leftEnc will come back as an Int, so packs directly into Int32 message type. 
        pub_enc.publish(msg_enc)  # Actually publish it in ROS. 
