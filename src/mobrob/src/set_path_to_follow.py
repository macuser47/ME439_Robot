...
# Roughly square path with rounded corners
path_specs = np.array([robot.specify_line(0,0,0, 0.5),robot.specify_arc(0,0.5,0.1,0.6, 0.1*np.pi/4, way='short'),robot.specify_line(0.1, 0.6, 0.6, 0.6)] )
